...
var Module = typeof tools !== 'undefined' ? tools : {};
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5565232,
    DYNAMIC_BASE = 5565232,
    DYNAMICTOP_PTR = 322320;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=322176;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 322224, 4), 322224);
...
if (!Module["abortStackOverflow"]) Module["abortStackOverflow"] = function() { abort("'abortStackOverflow' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };Module["ALLOC_NORMAL"] = ALLOC_NORMAL;
